	...
	<div id="create">
		...
		<form class="form-create-game" @submit.prevent="createGame">
			<div class="form-floating">
				<input type="text" id="gameName" class="form-control" placeholder="Game Name" v-model="game.gameName"
					required autofocus />
				<label for="gameName" class="sr-only">Game Name</label>
			</div>

			<div class="form-floating">
				<select name="length" id="length" class="form-control" v-model.number="game.gameLengthDays" required>
